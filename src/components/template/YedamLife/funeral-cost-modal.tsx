...
export function FuneralCostModal({
  ...
  const calcResult = useCallback(() => {
    ...
    if (funeralType === 'nobinso') {
      ...
      const total = transfer + mortuary + encoffin;
      return {
    ...
    const total = facilityFee + encoffin + transfer + mortuary + food;
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-2xl sm:rounded-2xl bg-white overflow-hidden flex flex-col">
        ...
        {step === resultStep &&
          selectedHall &&
          (() => {
            const recommended = getRecommendedProduct(calcResult()?.total ?? 0);
            return (
              <div
