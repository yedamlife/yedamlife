      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8 sm:space-y-12">
        ...
        >
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            ...
            {(intro.facility_rating != null || intro.traffic_rating != null) && (
              <div className="mt-5 pt-5 border-t border-gray-100 grid grid-cols-2 gap-3">
                {intro.facility_rating != null && (
                  <RatingItem label="편의시설" value={intro.facility_rating} />
                )}
                {intro.traffic_rating != null && (
                  <RatingItem label="교통편" value={intro.traffic_rating} />
                )}
              </div>
            )}
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 safe-area-bottom">
        <div className="max-w-5xl mx-auto flex items-center">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 py-4.5 text-gray-800 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-4.5 bg-[#2c3e50] text-white cursor-pointer"
          >
  ...
  return (
    <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2.5">
      ...
      <div className="flex items-center gap-1">
        ...
        <span className="ml-1 text-xs font-semibold text-gray-700 tabular-nums">
          {value.toFixed(1)}
        </span>
      </div>
    </div>
